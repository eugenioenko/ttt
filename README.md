...
- **Syntax highlighting** powered by [textmate-go](https://github.com/eugenioenko/textmate-go), our pure Go port of VS Code's TextMate engine: 124 languages, with multi-line constructs handled correctly

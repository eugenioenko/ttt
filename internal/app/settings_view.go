...
func settingsCategories() []settingsCategory {
	return []settingsCategory{
		...
		{Title: "Appearance", Fields: []settingField{
			...
			{Label: "Background image", Kind: settingString,
				GetString: func(s *config.Settings) string { return s.Editor.BackgroundImage },
				SetString: func(s *config.Settings, v string) { s.Editor.BackgroundImage = v }},
			{Label: "Background image dim (%)", Kind: settingInt, Min: 0,
				GetInt: func(s *config.Settings) int { return s.Editor.BackgroundImageDim },
				SetInt: func(s *config.Settings, v int) { s.Editor.BackgroundImageDim = v }},

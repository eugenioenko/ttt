...
func settingsCategories() []settingsCategory {
	return []settingsCategory{
		...
		{Title: "Advanced", Fields: []settingField{
			...
			{Label: "Fold chevron: collapsed", Kind: settingString,
				GetString: func(s *config.Settings) string { return s.Editor.FoldChevronCollapsed },
				SetString: func(s *config.Settings, v string) { s.Editor.FoldChevronCollapsed = v }},
			{Label: "Fold chevron: expanded", Kind: settingString,
				GetString: func(s *config.Settings) string { return s.Editor.FoldChevronExpanded },
				SetString: func(s *config.Settings, v string) { s.Editor.FoldChevronExpanded = v }},
			{Label: "Sidebar: collapsed chevron", Kind: settingString,
				GetString: func(s *config.Settings) string { return s.Sidebar.TreeChevronCollapsed },
				SetString: func(s *config.Settings, v string) { s.Sidebar.TreeChevronCollapsed = v }},
			{Label: "Sidebar: expanded chevron", Kind: settingString,
				GetString: func(s *config.Settings) string { return s.Sidebar.TreeChevronExpanded },
				SetString: func(s *config.Settings, v string) { s.Sidebar.TreeChevronExpanded = v }},
